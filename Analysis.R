...
model.Allvar <- lm(price_doc ~ id + timestamp + full_sq +	life_sq + floor + max_floor + num_room + kitch_sq + product_type
                   ...
                   + build_count_frame + build_count_brick + build_count_before_1920 + build_count_1921_1945 + build_count_1946_1970
                   ...
                   + railroad_station_avto_km + railroad_station_avto_min + public_transport_station_km + public_trans_station_time_walk
