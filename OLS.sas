...
run;
/* stepwise regression - this produces adjusted r squared of 0.4347 with 30 variables included*/ 
...
seed=1 plots(stepAxis=number)=(criterionPanel ASEPlot CRITERIONPANEL);   
CLASS PRODUCT_TYPE; 
model PRICE_DOC = ID	full_sq	max_floor	kitch_sq	indust_part	children_school	university_top_20_raion	shopping_centers_raion	railroad_terminal_raion	build_count_before_1920	build_count_1921_1945	build_count_1946_1970	build_count_1971_1995	build_count_after_1995	school_km	green_zone_km	industrial_km	ID_railroad_station_walk	kremlin_km	big_road2_km	railroad_km	bus_terminal_avto_km	big_market_km	ice_rink_km	basketball_km	public_healthcare_km	shopping_centers_km	office_km healthcare_centers_raion*public_healthcare_km
/ selection=stepwise( choose=CV stop=CV include = 30) CVdetails;                                                                                                                                                                                                                                               
run;
quit;*/
...
/* forward selection - this produces adjusted r squared of 0.4347 with 30 variables included */
proc glmselect data=DF 
testdata=DF                                                                                                                                                                                 
seed=1 plots(stepAxis=number)=(criterionPanel ASEPlot CRITERIONPANEL);   
CLASS PRODUCT_TYPE; 
